            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <h3 className="text-lg font-medium text-blue-900">View Students</h3>
                  <p className="text-blue-700 text-sm mt-1">Manage student records and information</p>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <h3 className="text-lg font-medium text-green-900">Manage Classes</h3>
                  <p className="text-green-700 text-sm mt-1">View and manage class schedules</p>
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                  <h3 className="text-lg font-medium text-purple-900">Enter Results</h3>
                  <p className="text-purple-700 text-sm mt-1">Record and manage exam results</p>
                  ...
                  <li className="py-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-gray-500">John Smith - Grade 10</p>
                      </div>
                  ...
                  <li className="py-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-gray-500">Mathematics - Grade 9A</p>
                      </div>
                      <div className="flex-shrink-0 text-sm text-gray-500">
                        5 hours ago
                      </div>
                  ...
                  <li className="py-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-gray-500">Physics - Grade 11</p>
                      </div>
                      <div className="flex-shrink-0 text-sm text-gray-500">
                        1 day ago
                      </div>
